...
/*
** The component 2716 is composed of 14 pins. It has 4 OR gates
** which works for each of them with two inputs and one output.
*/
nts::C2716::C2716(const std::string &name) : AComponent(name, "chipset") {
  this->_nbPins = 24;
  this->_VSS = 12;
  this->_VDD = 24;
  ...
  // Create the pins of the chipset 2716 and set them.
...
void            nts::C2716::setValueOnOutputs(int value) {
...
int             nts::C2716::getValueFromOutputs() {
